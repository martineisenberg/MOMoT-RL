 ...
 */
public class MOHVCalculator {

   private static String CASE_PATH = "output/populations/MO/TTC_D/";
   ...
   private static final int TL_INDEX = 0;
         ...
         for(final String dir : directories) {
            ...
            try {
               ...
               for(final double[] element : popList) {
                  if(!INCLUDE_INITIAL_MODEL_SOLUTION && element[TL_INDEX] == 0) {
                     continue;
                  }
   ...
   public static void main(final String... args) throws IOException, ClassNotFoundException {
      ...
      final String initialGraph = "model/TTC_InputRDG_B.xmi";
      ...
      final NondominatedPopulation referenceSet = buildReferenceSet(CASE_PATH, "Chebyscheff", "MOQTournament", "NSGAII",
            "PQ-HV", "PQ-PO");
      ...
      sb = computeStatistics(orchestration.getProblem(), referenceSet, CASE_PATH, sb, CASE_PATH, "Chebyscheff",
            "MOQTournament", "NSGAII", "PQ-HV", "PQ-PO");
